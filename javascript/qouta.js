document.getElementById("third-btn").addEventListener("click",function(event){
    ...
    const addMoney = getInputFieldValuedById("third-input");
    ...
    console.log(current);
        ...
        if( addMoney<=current){
            ...
            const updatedDonation = getTextFieldValueById("donatedMoney3")+ addMoney;
            console.log(updatedDonation);
            document.getElementById("donatedMoney3").innerText=updatedDonation;
            ...
            p.innerText = `Donated  for Qouta: ${addMoney} tk. at ${currentTime} , date: ${date}`;
            console.log(p);
